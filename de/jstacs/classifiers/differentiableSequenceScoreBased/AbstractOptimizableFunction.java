...
public abstract class AbstractOptimizableFunction extends OptimizableFunction {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.classifiers.differentiableSequenceScoreBased.OptimizableFunction#setDataAndWeights(de.jstacs.data.DataSet[], double[][])
	 */
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifiers.differentiableSequenceScoreBased.OptimizableFunction#getParameters(KindOfParameter)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifiers.differentiableSequenceScoreBased.OptimizableFunction#getData()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifiers.differentiableSequenceScoreBased.OptimizableFunction#getSequenceWeights()
	 */
	@Override
