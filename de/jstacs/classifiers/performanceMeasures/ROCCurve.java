 ...
 * The Receiver Operating Characteristics curve is the plot of sensitivity (\( \frac{TP}{TP+FN} \)) 
 * against the false positive rate ( \( \frac{FP}{FP+TN} \)) for all possible classification thresholds.
 * 
