 ...
 * The precision-recall curve is the plot of precision (also called positive predictive value, \( \frac{TP}{TP+FP} \) ) 
 * against recall (also called sensitivity, \( \frac{TP}{TP+FN} \)) for all possible classification thresholds.
 * 
