...
public class SharedStructureClassifier extends ModelBasedClassifier {
	 ...
	 * {@link FSDAGModel}s. This is the main constructor.
	 * 
	 * @param length
	 *            the sequence length
	 * @param model
	 ...
	 * @see ModelType
	 * @see LearningType
	 * @see ModelBasedClassifier#ModelBasedClassifier(boolean,de.jstacs.models.Model[])
	 */
	public SharedStructureClassifier( int length, ModelType model, byte order, LearningType method, FSDAGModel... models )
																															throws IllegalArgumentException,
	 ...
	 * @see ModelBasedClassifier#ModelBasedClassifier(StringBuffer)
	 */
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.modelBased.ModelBasedClassifier#clone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.modelBased.ModelBasedClassifier#getInstanceName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.modelBased.ModelBasedClassifier#extractFurtherClassifierInfosFromXML(java.lang.StringBuffer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.modelBased.ModelBasedClassifier#getFurtherClassifierInfos()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.modelBased.ModelBasedClassifier#getClassifierAnnotation()
	 */
	@Override
	public CategoricalResult[] getClassifierAnnotation() {
		...
		while( i < models.length ) {
			res[i + 1] = new CategoricalResult( "class info " + i,
					...
					BayesianNetworkModelParameterSet.getModelInstanceName( model, order, method, ( (FSDAGModel)models[i++] ).getESS() ) );
		}
		return res;
	}
}
