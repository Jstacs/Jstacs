...
public abstract class HiddenMotifMixture extends AbstractMixtureModel implements MotifDiscoverer {
	 ...
	 */
	protected HiddenMotifMixture( Model[] models, boolean[] optimzeArray, int components, int starts, boolean estimateComponentProbs, double[] componentHyperParams,
	...
	/* (non-Javadoc)
	 * @see de.jstacs.models.mixture.AbstractMixtureModel#getFurtherInformation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.models.mixture.AbstractMixtureModel#extractFurtherInformation(java.lang.StringBuffer)
	 */
	@Override
