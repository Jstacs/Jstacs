 ...
 */
public class ViterbiParameterSet extends MaxHMMTrainingParameterSet {
	 ...
	 */
	public ViterbiParameterSet( int starts, AbstractTerminationCondition tc ) throws Exception {
		super( starts, tc );
	}
