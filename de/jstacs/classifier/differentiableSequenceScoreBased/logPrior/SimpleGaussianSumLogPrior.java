...
public class SimpleGaussianSumLogPrior extends LogPrior {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.logPrior.LogPrior#addGradientFor(double[], double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.logPrior.LogPrior#getNewInstance()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.logPrior.LogPrior#toXML()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.logPrior.LogPrior#getInstanceName()
	 */
	@Override
