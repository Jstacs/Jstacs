...
public abstract class AbstractOptimizableFunction extends OptimizableFunction {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.OptimizableFunction#getParameters(KindOfParameter)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.OptimizableFunction#getData()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.OptimizableFunction#getSequenceWeights()
	 */
	@Override
