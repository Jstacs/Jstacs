...
public class MSPClassifier extends GenDisMixClassifier {
	 ...
	 *            the parameter set for the classifier
	 * @param prior
	 *            the prior that shall be used; the learning principle depends on the prior: if the prior is <code>null</code> or {@link de.jstacs.classifier.differentiableSequenceScoreBased.logPrior.DoesNothingLogPrior} then MCL is used otherwise MSP
	 * @param score
	 *            the {@link DifferentiableSequenceScore}s for the classes
	 * 
	 * @throws CloneNotSupportedException
	 ...
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.ScoreClassifier#NOT_TRAINED_VALUE
	 ...
	 * {@link de.jstacs.classifier.differentiableSequenceScoreBased.ScoreClassifier#getLastScore()}. This might be useful if the parameters of the classifier are
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.ScoreClassifier#getXMLTag()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.classifier.differentiableSequenceScoreBased.ScoreClassifier#getInstanceName()
	 */
	@Override
