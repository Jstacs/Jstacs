...
public abstract class SamplingScoreBasedClassifier extends AbstractScoreBasedClassifier {
	 ...
	 * This is for instance necessary in case of {@link de.jstacs.classifier.differentiableSequenceScoreBased.gendismix.LogGenDisMixFunction} to
	 ...
	 */
	protected double sampleNSteps( DiffSSBasedOptimizableFunction function, ScoringFunctionSamplingComponent component, BurnInTest test, int numSteps, SamplingScheme scheme ) throws Exception{
	 ...
	 */
	protected void sample(ScoringFunctionSamplingComponent sfsc, DiffSSBasedOptimizableFunction function) throws Exception{
