...
/**
 * Interface for {@link NormalizableScoringFunction}s that can be used for
 * Metropolis-Hastings sampling in a {@link de.jstacs.classifier.scoringFunctionBased.sampling.SamplingScoreBasedClassifier}.
 * 
 * @author Jan Grau
 *
 */
public interface SamplingScoringFunction extends NormalizableScoringFunction {
