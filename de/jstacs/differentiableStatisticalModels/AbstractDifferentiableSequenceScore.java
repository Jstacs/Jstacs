...
public abstract class AbstractDifferentiableSequenceScore implements DifferentiableSequenceScore {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getAlphabetContainer()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getLength()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getLogScore(de.jstacs.data.Sequence)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getLogScoreAndPartialDerivation(int, de.jstacs.data.Sequence, int, de.jstacs.utils.IntList, de.jstacs.utils.DoubleList)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getNumberOfRecommendedStarts()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getInitialClassParam(double)
	 */
