...
package de.jstacs.differentiableStatisticalModels.mix;
...
public abstract class AbstractMixtureDiffSM extends AbstractDifferentiableStatisticalModel implements SamplingDifferentiableStatisticalModel {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getLogScore(de.jstacs.data.Sequence, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#getNormalizationConstant()
	 */
