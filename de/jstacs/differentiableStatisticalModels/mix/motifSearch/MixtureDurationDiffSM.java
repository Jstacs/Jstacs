...
/**
 * This class implements a mixture of {@link DurationDiffSM}s.
 * 
...
public class MixtureDurationDiffSM extends DurationDiffSM {
	...
	/**
	 * The main constructor of a {@link MixtureDurationDiffSM}.
	 * 
	 * @param starts the number of recommended starts
	 * @param function the {@link DurationDiffSM}s for the components
	 * 
	 ...
	 * {@link MixtureDurationDiffSM} out of a {@link StringBuffer}.
	 * 
	 * @param source
	...
	protected void fromXML( StringBuffer rep ) throws NonParsableException
	{
		...
		super.fromXML(xml);
		function = XMLParser.extractObjectForTags( xml, "components", DurationDiffSM[].class );		hiddenParams = XMLParser.extractObjectForTags( xml, "hiddenParams", double[].class );
