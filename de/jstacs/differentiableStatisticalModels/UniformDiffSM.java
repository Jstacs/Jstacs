...
public class UniformDiffSM extends BasicUniformDiffSM implements SamplingDifferentiableStatisticalModel {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.BasicUniformDiffSM#getLogScore(de.jstacs.data.Sequence, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.BasicUniformDiffSM#getLogScoreAndPartialDerivation(de.jstacs.data.Sequence, int, de.jstacs.utils.IntList, de.jstacs.utils.DoubleList)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.BasicUniformDiffSM#getFurtherInformation()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.BasicUniformDiffSM#extractFurtherInformation(java.lang.StringBuffer)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.BasicUniformDiffSM#toString()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#getLogPriorTerm()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#addGradientOfLogPriorTerm(double[], int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.AbstractDifferentiableStatisticalModel#isNormalized()
	 */
	@Override
