...
public interface MutableMotifDiscoverer extends MotifDiscoverer {
	 ...
	 * 
	 * @throws Exception either if the index is wrong or if it is thrown by the method {@link de.jstacs.scoringFunctions.NormalizableScoringFunction#initializeFunctionRandomly(boolean)}
	 */
