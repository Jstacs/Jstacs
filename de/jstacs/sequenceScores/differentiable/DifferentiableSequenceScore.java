...
public interface DifferentiableSequenceScore extends SequenceScore {
	/**
	 * Indicates that the number of parameters of this {@link DifferentiableSequenceScore}
	 * is not known (yet).
	 */
	public static final int UNKNOWN = -1;

	/**
	 * Creates a clone (deep copy) of the current {@link DifferentiableSequenceScore}
	 * instance.
	 * 
	 * @return the cloned instance of the current {@link DifferentiableSequenceScore}
	 * 
	 * @throws CloneNotSupportedException
	 *             if something went wrong while cloning the
	 *             {@link DifferentiableSequenceScore}
	 */
	public DifferentiableSequenceScore clone() throws CloneNotSupportedException;
	...
	/**
	 * This method initializes the {@link DifferentiableSequenceScore} randomly. It has to
	 * create the underlying structure of the {@link DifferentiableSequenceScore}.
	 * 
	 * @param freeParams
	 *            indicates whether the (reduced) parameterization is used
	 * 
	...
	/**
	 * Returns the number of parameters in this {@link DifferentiableSequenceScore}. If the
	 * number of parameters is not known yet, the method returns
	 * {@link #UNKNOWN}.
	 * 
	 * @return the number of parameters in this {@link DifferentiableSequenceScore}
	 * 
	 * @see DifferentiableSequenceScore#UNKNOWN
	 */
	 ...
	 * {@link DifferentiableSequenceScore} is responsible for, based on the class
