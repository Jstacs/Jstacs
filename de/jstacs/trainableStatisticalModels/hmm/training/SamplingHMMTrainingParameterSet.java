...
package de.jstacs.trainableStatisticalModels.hmm.training;
...
/**
 * This class contains the parameters for training training an {@link de.jstacs.trainableStatisticalModels.hmm.AbstractHMM} using a sampling strategy.
 * 
...
public class SamplingHMMTrainingParameterSet extends HMMTrainingParameterSet {
	...
	/**
	 * This is the main constructor creating an already filled parameter set for training an {@link de.jstacs.trainableStatisticalModels.hmm.AbstractHMM} using a sampling strategy.
	 * 
