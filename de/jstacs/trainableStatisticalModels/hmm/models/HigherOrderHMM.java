...
package de.jstacs.trainableStatisticalModels.hmm.models;
...
import de.jstacs.trainableStatisticalModels.hmm.AbstractHMM;
import de.jstacs.trainableStatisticalModels.hmm.HMMTrainingParameterSet;
import de.jstacs.trainableStatisticalModels.hmm.Transition;
import de.jstacs.trainableStatisticalModels.hmm.states.SimpleState;
import de.jstacs.trainableStatisticalModels.hmm.states.TrainableState;
import de.jstacs.trainableStatisticalModels.hmm.states.emissions.Emission;
import de.jstacs.trainableStatisticalModels.hmm.training.BaumWelchParameterSet;
import de.jstacs.trainableStatisticalModels.hmm.training.MaxHMMTrainingParameterSet;
import de.jstacs.trainableStatisticalModels.hmm.training.ViterbiParameterSet;
import de.jstacs.trainableStatisticalModels.hmm.transitions.TrainableTransition;
import de.jstacs.trainableStatisticalModels.hmm.transitions.BasicHigherOrderTransition.AbstractTransitionElement;
...
public class HigherOrderHMM extends AbstractHMM {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.hmm.AbstractHMM#getLogProbForPath(int[], int, de.jstacs.data.Sequence[])
	 */
	 ...
	 * 
	 * @throws Exception forwarded from {@link TrainableState#addToStatistic} and {@link de.jstacs.trainableStatisticalModels.hmm.State#getLogScoreFor(int, int, Sequence)}
	 */
