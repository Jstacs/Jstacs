...
package de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.shared;
...
import de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.FSDAGTrainSM;
import de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.StructureLearner;
...
import de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.parameters.IDGTrainSMParameterSet;
...
public class SharedStructureMixture extends MixtureTrainSM {
	 ...
	 *      de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.StructureLearner.ModelType, byte, int, boolean, double[], double, TerminationCondition)
	 */
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#toXML()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#fromXML(java.lang.StringBuffer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#getNewParameters(int, double[][], double[])
	 */
	@Override
