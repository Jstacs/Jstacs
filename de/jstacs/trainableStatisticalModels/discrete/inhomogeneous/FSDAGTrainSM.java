...
import de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.parameters.FSDAGMParameterSet;
...
public class FSDAGTrainSM extends DAGTrainSM {
	 ...
	 * 
	 * @param models
	 *            an array of {@link de.jstacs.trainableStatisticalModels.AbstractTrainSM}s containing
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.InhomogeneousDGTrainSM#set(de.jstacs.trainableStatisticalModels.discrete.DGTrainSMParameterSet, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.DAGTrainSM#getStructure()
	 */
	@Override
