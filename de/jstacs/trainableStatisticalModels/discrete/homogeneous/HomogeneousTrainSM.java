...
package de.jstacs.trainableStatisticalModels.discrete.homogeneous;
...
import de.jstacs.trainableStatisticalModels.discrete.Constraint;
import de.jstacs.trainableStatisticalModels.discrete.DGTrainSMParameterSet;
import de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM;
import de.jstacs.trainableStatisticalModels.discrete.homogeneous.parameters.HomogeneousTrainSMParameterSet;
...
public abstract class HomogeneousTrainSM extends DiscreteGraphicalTrainSM {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#set(de.jstacs.trainableStatisticalModels.discrete.DGTrainSMParameterSet, boolean)
	 */
	@Override
	 ...
	 * {@link de.jstacs.trainableStatisticalModels.TrainableStatisticalModel#getLogProbFor(Sequence, int, int)} after
	 ...
	 * @see de.jstacs.trainableStatisticalModels.TrainableStatisticalModel#getLogProbFor(Sequence, int, int)
	 */
	...
	protected class HomCondProb extends Constraint {
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#estimate(double)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#satisfiesSpecificConstraint(de.jstacs.data.Sequence, int)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#toString()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#appendAdditionalInfo(java.lang.StringBuffer)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#getXMLTag()
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#estimateUnConditional(int, int, double, boolean)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#extractAdditionalInfo(java.lang.StringBuffer)
		 */
		@Override
