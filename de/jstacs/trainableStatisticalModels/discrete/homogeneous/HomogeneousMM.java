...
public class HomogeneousMM extends HomogeneousTrainSM {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#clone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.homogeneous.HomogeneousTrainSM#getRandomSequence(java.util.Random, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.homogeneous.HomogeneousTrainSM#logProbFor(de.jstacs.data.Sequence, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#toString()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.homogeneous.HomogeneousTrainSM#train(de.jstacs.data.Sample[], double[][])
	 */
	@Override
	public void train( DataSet[] data, double[][] weights ) throws Exception {
		// check
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#getFurtherModelInfos()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#getXMLTag()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.homogeneous.HomogeneousTrainSM#set(de.jstacs.trainableStatisticalModels.discrete.DGTrainSMParameterSet, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.DiscreteGraphicalTrainSM#setFurtherModelInfos(java.lang.StringBuffer)
	 */
	@Override
	protected void setFurtherModelInfos( StringBuffer xml ) throws NonParsableException {
		if( trained ) {
			condProb = XMLParser.extractObjectAndAttributesForTags(xml, "condProb", null, null, HomCondProb[].class, HomogeneousTrainSM.class, this);
			/*TODO remove
