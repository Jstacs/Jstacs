...
import de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM;
...
public abstract class HiddenMotifMixture extends AbstractMixtureTrainSM implements MotifDiscoverer {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#clone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#getFurtherInformation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#extractFurtherInformation(java.lang.StringBuffer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#train(de.jstacs.data.Sample, double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#checkLength(int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#getInstanceName()
	 */
	@Override
