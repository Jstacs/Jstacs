...
package de.jstacs.trainableStatisticalModels.mixture;
 ...
 * 
 * @see de.jstacs.trainableStatisticalModels.TrainableStatisticalModel
 * 
...
public class StrandTrainSM extends AbstractMixtureTrainSM {
	 ...
	 *      de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Parameterization, int,
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#emitSampleUsingCurrentParameterSet(int, int[])
	 */
	@Override
