...
package de.jstacs.trainableStatisticalModels.mixture.motif;
...
import de.jstacs.trainableStatisticalModels.mixture.motif.positionprior.UniformPositionPrior;
...
public class ZOOPSTrainSM extends HiddenMotifMixture {
	 ...
	 *            {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#GIBBS_SAMPLING} the
	 ...
	 *            <code>algorithm == {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#GIBBS_SAMPLING}</code>
	 ...
	 *            be used
	 * @param algorithm
	 *            either {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#EM} or
	 *            {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#GIBBS_SAMPLING}
	 * @param alpha
	 *            only for {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#EM}<br>
	 ...
	 *            <ul>
	 *            <li>{@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Parameterization#THETA} or
	 *            {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Parameterization#LAMBDA}
	 ...
	 *            only for {@link de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM.Algorithm#GIBBS_SAMPLING}<br>
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#setTrainData(de.jstacs.data.Sample)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#createSeqWeightsArray()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#doFirstIteration(double[], de.jstacs.utils.random.MultivariateRandomGenerator, de.jstacs.utils.random.MRGParams[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#getNewWeights(double[], double[], double[][])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.AbstractMixtureTrainSM#getLogProbUsingCurrentParameterSetFor(int, de.jstacs.data.Sequence, int, int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.motif.HiddenMotifMixture#getMinimalSequenceLength()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.mixture.motif.HiddenMotifMixture#trainBgModel(de.jstacs.data.Sample, double[])
	 */
