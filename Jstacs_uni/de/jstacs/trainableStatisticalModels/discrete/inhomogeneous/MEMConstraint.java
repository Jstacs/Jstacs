...
public class MEMConstraint extends InhConstraint {
	 ...
	 * 
	 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#Constraint(int[], int)
	 */
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.InhConstraint#clone()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#reset()
	 */
	@Override
	public void reset() {
		super.reset();
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.Constraint#getFreq(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.InhConstraint#appendAdditionalInfo(java.lang.StringBuffer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.InhConstraint#extractAdditionalInfo(java.lang.StringBuffer)
	 */
	@Override
