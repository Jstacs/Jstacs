...
package de.jstacs.trainableStatisticalModels.discrete.inhomogeneous;
...
import de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.parameters.FSDAGTrainSMForGibbsSamplingParameterSet;
...
public class FSDAGModelForGibbsSampling extends FSDAGTrainSM implements GibbsSamplingModel {
	 ...
	 * 
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.DAGTrainSM#clone()
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.DAGTrainSM#drawParameters(de.jstacs.data.Sample, double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.DAGTrainSM#getFurtherModelInfos()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.DAGTrainSM#setFurtherModelInfos(java.lang.StringBuffer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.FSDAGTrainSM#drawParameters(de.jstacs.data.Sample, double[], int[][])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.FSDAGTrainSM#train(de.jstacs.data.Sample, double[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.discrete.inhomogeneous.FSDAGTrainSM#train(de.jstacs.data.Sample, double[], int[][])
	 */
	@Override
