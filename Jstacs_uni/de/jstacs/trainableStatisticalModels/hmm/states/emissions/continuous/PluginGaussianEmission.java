package de.jstacs.trainableStatisticalModels.hmm.states.emissions.continuous;
...
public class PluginGaussianEmission extends GaussianEmission
{
	 ...
	 * 
	 * (non-Javadoc)
	 * @see de.jstacs.trainableStatisticalModels.hmm.states.emissions.GaussianEmission#initializeFunctionRandomly()
	 */
