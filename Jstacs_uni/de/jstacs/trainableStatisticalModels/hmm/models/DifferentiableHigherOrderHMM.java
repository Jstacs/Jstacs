...
import de.jstacs.trainableStatisticalModels.NormalizableScoringFunctionModel;
import de.jstacs.trainableStatisticalModels.hmm.State;
import de.jstacs.trainableStatisticalModels.hmm.states.DifferentiableState;
import de.jstacs.trainableStatisticalModels.hmm.states.SimpleDifferentiableState;
...
import de.jstacs.trainableStatisticalModels.hmm.transitions.DifferentiableTransition;
...
/**
 * This class combines an {@link HigherOrderHMM} and a {@link de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel} by implementing some of the declared methods. 
 * 
...
public class DifferentiableHigherOrderHMM extends HigherOrderHMM implements SamplingDifferentiableStatisticalModel {	
	 ...
	 * @param te the {@link TransitionElement}s used for creating a {@link de.jstacs.trainableStatisticalModels.hmm.Transition}
	 * 
	 * @throws Exception if 
	 * 	<ul>
