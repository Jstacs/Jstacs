...
public interface DifferentiableTransition extends Transition {
	 ...
	 * parameters that are living on a common simplex, e.g. the parameters of one {@link de.jstacs.trainableStatisticalModels.hmm.transitions.elements.TransitionElement}
