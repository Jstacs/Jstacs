...
/**/	
	...
	public static abstract class AbstractTransitionElement implements Cloneable, Storable {
		 ...
		 * 
		 * @see de.jstacs.trainableStatisticalModels.hmm.transitions.BasicHigherOrderTransition.AbstractTransitionElement#BasicHigherOrderTransition.AbstractTransitionElement(int[], int[], double[], double[])
		 */
		 ...
		 * 
		 * @see de.jstacs.trainableStatisticalModels.hmm.Transition#getGraphizNetworkRepresentation(NumberFormat, String, boolean)
		 ...
		 * 
		 * @see de.jstacs.trainableStatisticalModels.hmm.Transition#getLogPriorTerm()
		 */
		public double getLogPriorTerm() {
		 ...
		 * @param sequencePosition the position within the sequence
		 * 
		 * @see de.jstacs.trainableStatisticalModels.hmm.transitions.TrainableTransition#addToStatistic(int, int, int, double, Sequence, int)
		 * @see #statistic
		 * @see #resetStatistic()
		 ...
		 * @see #resetStatistic()
		 * @see #addToStatistic(int, double, Sequence, int)
		 * @see de.jstacs.trainableStatisticalModels.hmm.transitions.TrainableTransition#estimateFromStatistic()
		 */
		public void estimateFromStatistic() {
			if( states.length > 0 ) {
				logNorm = 0;
		 ...
		 * @see #drawParametersFromStatistic()
		 * @see #addToStatistic(int, double, Sequence, int)
		 * @see de.jstacs.trainableStatisticalModels.hmm.transitions.TransitionWithSufficientStatistic#resetStatistic()
		 */
		public void resetStatistic() {
