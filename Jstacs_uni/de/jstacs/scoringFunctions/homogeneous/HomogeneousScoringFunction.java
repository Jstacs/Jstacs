...
import de.jstacs.scoringFunctions.AbstractVariableLengthScoringFunction;
import de.jstacs.scoringFunctions.SamplingScoringFunction;

/**
 * This is the main class for all homogeneous {@link de.jstacs.scoringFunctions.ScoringFunction}s.
 * 
 * @author Jens Keilwagen
 */
public abstract class HomogeneousScoringFunction extends
		AbstractVariableLengthScoringFunction implements SamplingScoringFunction {

	/**
	 * This is the main constructor that creates an instance of a
	 * {@link HomogeneousScoringFunction} that models sequences of arbitrary
	 * length.
	 * 
	 * @param alphabets
	...
	/**
	 * This is the main constructor that creates an instance of a
	 * {@link HomogeneousScoringFunction} that models sequences of a given
	 * length.
	 * 
	 * @param alphabets
	 *            the {@link AlphabetContainer}
	 ...
	 * {@link HomogeneousScoringFunction} out of its XML representation.
	 * 
	 * @param source
