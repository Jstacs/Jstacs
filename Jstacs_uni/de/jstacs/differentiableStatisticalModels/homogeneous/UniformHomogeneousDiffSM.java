...
package de.jstacs.differentiableStatisticalModels.homogeneous;
...
public class UniformHomogeneousDiffSM extends HomogeneousDiffSM {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.AbstractVariableLengthDiffSM#getLogScoreFor(int, de.jstacs.data.Sequence, int)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.AbstractVariableLengthDiffSM#getLogScoreAndPartialDerivation(int, de.jstacs.data.Sequence, int, de.jstacs.utils.IntList, de.jstacs.utils.DoubleList)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#setParameters(double[],
	 * int)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.VariableLengthDiffSM#
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.AbstractDifferentiableStatisticalModel#fromXML
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#getEss()
	 */
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#getLogPriorTerm()
	 */
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#getCurrentParameterValues()
	 */
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.AbstractDifferentiableStatisticalModel#isNormalized
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableSequenceScore#initializeFunctionRandomly
	 * (boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.jstacs.differentiableStatisticalModels.VariableLengthDiffSM#setStatisticForHyperparameters(int[], double[])
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.homogeneous.HomogeneousDiffSM#initializeUniformly(boolean)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.SamplingDifferentiableStatisticalModel#getSamplingGroups(int)
	 */
	@Override
