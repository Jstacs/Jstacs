 ...
 */
public class HiddenMotifsMixture extends AbstractMixtureDiffSM implements MutableMotifDiscoverer
{
	/**
	 ...
	 */
	public HiddenMotifsMixture( boolean type, int length, int starts, boolean plugIn, HomogeneousDiffSM bg,
