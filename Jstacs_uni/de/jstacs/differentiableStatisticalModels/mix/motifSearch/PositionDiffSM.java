...
package de.jstacs.differentiableStatisticalModels.mix.motifSearch;
 ...
 * 
 * @see Sequence
 * @see PositionDiffSM#reset()
 * @see PositionDiffSM#next()
 * @see PositionDiffSM#getLogScoreForInternal()
 * @see PositionDiffSM#getLogScoreAndPartialDerivationForInternal(IntList, DoubleList)
 * 
...
{
	/**
	 * This array is used for some method of {@link DurationDiffSM} that use an internal memory
	 * 
	 * @see DurationDiffSM#reset()
	 * @see DurationDiffSM#next()
	 * @see DurationDiffSM#getInternalPosition(int[])
	 */
