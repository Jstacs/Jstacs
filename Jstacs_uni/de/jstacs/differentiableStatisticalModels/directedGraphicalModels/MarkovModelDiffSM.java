...
/**
 * This class implements a {@link de.jstacs.differentiableStatisticalModels.AbstractDifferentiableStatisticalModel} for an inhomogeneous Markov model.
...
public class MarkovModelDiffSM extends BayesianNetworkDiffSM implements Mutable, SamplingDifferentiableStatisticalModel{
	 ...
	 * @param ess the equivalent sample size
	 * @param plugInParameters a switch whether to use plug-in parameters of not
	 * @param structureMeasure an {@link InhomogeneousMarkov} {@link de.jstacs.differentiableStatisticalModels.directedGraphicalModels.structureLearning.measures.Measure} for the structure
	 * 
	 ...
	 * @param ess the equivalent sample size
	 * @param plugInParameters a switch whether to use plug-in parameters of not
	 * @param structureMeasure a {@link InhomogeneousMarkov} {@link de.jstacs.differentiableStatisticalModels.directedGraphicalModels.structureLearning.measures.Measure} for the structure
	 * @param lengthPenalty the prior on the modeled sequence length
	 * 
	 * @throws Exception if super class constructor throws an {@link Exception} or if the <code>lengthPenalty</code> does not allow the initial length
	 */
	...
	/* (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.directedGraphicalModels.BayesianNetworkDiffSM#getLogPriorTerm()
	 */
	@Override
