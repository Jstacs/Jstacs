...
public abstract class AbstractDifferentiableStatisticalModel extends AbstractDifferentiableSequenceScore implements DifferentiableStatisticalModel {
	...
	/*
	 * (non-Javadoc)
	 * @see de.jstacs.differentiableStatisticalModels.AbstractDifferentiableSequenceScore#clone()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#isNormalized()
	 */
	 ...
	 * 
	 * @see
	 * de.jstacs.differentiableStatisticalModels.DifferentiableStatisticalModel#getInitialClassParam
	 * (double)
	 */
