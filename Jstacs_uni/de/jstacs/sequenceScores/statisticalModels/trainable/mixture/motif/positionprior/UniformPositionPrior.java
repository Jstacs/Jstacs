...
public class UniformPositionPrior extends PositionPrior {
	...
	/* (non-Javadoc)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.mixture.motif.positionprior.PositionPrior#getLogPriorForPositions(int, int[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.mixture.motif.positionprior.PositionPrior#getLength()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.mixture.motif.positionprior.PositionPrior#getInstanceName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.mixture.motif.positionprior.PositionPrior#getAdditionalInformation()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see de.jstacs.sequenceScores.statisticalModels.trainable.mixture.motif.positionprior.PositionPrior#extractAdditionalInformation(java.lang.StringBuffer)
	 */
	@Override
