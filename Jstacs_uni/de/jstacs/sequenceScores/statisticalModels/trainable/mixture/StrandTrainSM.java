 ...
 * 
 * @see de.jstacs.sequenceScores.statisticalModels.trainable.TrainableStatisticalModel
 * 
...
public class StrandTrainSM extends AbstractMixtureTrainSM {
	 ...
	 *             if the <code>models</code> can not be cloned
	 * 
	 * @see StrandTrainSM#StrandTrainSM(de.jstacs.sequenceScores.statisticalModels.trainable.TrainableStatisticalModel, int, boolean,
	 *      double[], double,
