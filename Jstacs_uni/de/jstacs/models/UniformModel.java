...
public class UniformModel extends AbstractModel
{
	...
	/**
	 * Creates a new {@link UniformModel} using a given {@link AlphabetContainer}.
	 * 
	 ...
	 * Creates a new {@link UniformModel} out of a {@link StringBuffer}.
	 * 
	...
	/* (non-Javadoc)
	 * @see de.jstacs.models.Model#getProbFor(de.jstacs.data.Sequence, int, int)
	 */
