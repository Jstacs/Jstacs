...
public abstract class DiscreteGraphicalModel extends AbstractModel implements InstantiableFromParameterSet {
	...
	/**
	 * The default constructor. Creates a new {@link DiscreteGraphicalModel}
	 * from a given {@link DGMParameterSet}.
	 * 
	 * @param params
	 ...
	 * 
	 * @see AbstractModel#AbstractModel(de.jstacs.data.AlphabetContainer, int)
	 */
	public DiscreteGraphicalModel( DGMParameterSet params ) throws CloneNotSupportedException, IllegalArgumentException,
