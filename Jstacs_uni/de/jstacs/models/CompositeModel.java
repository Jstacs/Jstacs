...
public class CompositeModel extends AbstractModel {
	...
	private static final String XML_TAG = "CompositeModel";
	...
	/**
	 * Creates a new {@link CompositeModel}.
	 * 
	 * @param alphabets
	 ...
	 */
	public CompositeModel(AlphabetContainer alphabets, int[] assignment,
			Model... models) throws WrongAlphabetException,
	 ...
	 * Creates a new {@link CompositeModel} out of a {@link StringBuffer}.
	 * 
	 * @param stringBuff
	 ...
	 */
	public CompositeModel(StringBuffer stringBuff) throws NonParsableException {
		super(stringBuff);
	}
	...
	public CompositeModel clone() throws CloneNotSupportedException {
		CompositeModel c = (CompositeModel) super.clone();
	 ...
	 */
	public Model[] getModels() throws CloneNotSupportedException {
		return ArrayHandler.clone(models);
	}

	/**
	 * This method returns the number of models in the {@link CompositeModel}.
	 * 
	 ...
	 * 
	 * @see
	 * de.jstacs.models.AbstractModel#getLogProbFor(de.jstacs.data.Sequence,
	 * int, int)
	 */
	@Override
