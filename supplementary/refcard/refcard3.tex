...
\entrys{statMod}{.emitDataSet(number,length)}{de/jstacs/sequenceScores/statisticalModels/StatisticalModel.html\#emitDataSet(int,\%20int...)}{Generate a given number of sequences with specified length from the model using the current parameter values}

\entrys{statMod}{.getLogProbFor(sequence)}{de/jstacs/sequenceScores/statisticalModels/StatisticalModel.htm\#getLogProbFor(de.jstacs.data.sequences.Sequence)}{Obtain the log probability (likelihood) of a sequence for a given model}
...
\entrys{diffSM}{.initializeFunctionRandomly()}{de/jstacs/sequenceScores/differentiable/DifferentiableSequenceScore.html\#initializeFunctionRandomly(boolean)}{Initialize the parameters of this model randomly}

\entrys{diffSM}{.getLogScoreFor(sequence)}{de/jstacs/sequenceScores/SequenceScore.html\#getLogScoreFor(de.jstacs.data.sequences.Sequence)}{Obtain a log score (typically proportional to the log-likelihood) of a sequence for a given model}

\entrys{diffSM}{.getLogScoreAndPartialDerivation(sequence,indices,partialDers)}{de/jstacs/sequenceScores/differentiable/DifferentiableSequenceScore.html\#getLogScoreAndPartialDerivation(de.jstacs.data.sequences.Sequence,\%20de.jstacs.utils.IntList,\%20de.jstacs.utils.DoubleList)}{Compute the partial derivations wrt. all parameters for the given sequences and store the parameter indexes and corresponding partial derivations in given lists}
